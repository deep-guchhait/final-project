...
router.post("/", async (req, res) => {
    ...
    try {
        ...
        if (productIndex > -1) {
            // if the product already exists, update the quantoty
...
// @route GET /api/cart
// @desc Get log-in user's or guest user's cart
// @access public
...
// @desc merge guest cart into user cart to login
// @access Private
router.post("/merge", protect, async (req, res) => {
    ...
    try {
        ...
        if(guestCart) {
            ...
            if (userCart) {
                // guest cart has already been marged, return user cart
