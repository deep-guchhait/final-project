...
router.post("/", protect, admin, async (req, res) => {
    try {
        ...
        const product = new Product({name, description, price, discountPrice, countInStock, category, brand, sizes, colors, collections, material, gender, images,isFeatured, isPublished, tags, dimentions, weight, sku, 
...
// @route GET /api/products/simailar/:id
// @desc similar products based on the current product's gender and category
// @access Public
