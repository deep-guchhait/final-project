    ...
    <div className='max-w-7xl mx-auto p-6'>
        ...
        {productsLoading || ordersLoading ? (
            ...
            <div className="p-4 bg-gray-900 shadow-md rounded-lg">
                <h2 className="text-xl text-white font-semibold">Revenue</h2>
                <p className="text-white text-2xl">₹ {totalSales.toFixed(2)}</p>
            </div>
            ...
            <div className="p-4 bg-gray-900 shadow-md rounded-lg">
                <h2 className="text-xl text-white font-semibold">Total Product</h2>
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full text-left text-gray-700">
                    ...
                    <tbody className='bg-lime-50'>
                        {orders.length > 0 ? (
                            orders.map((order) => (
                                <tr key={order._id} className='border-b hover:bg-lime-100 cursor-pointer'>
