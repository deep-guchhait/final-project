...
const EditProductPage = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md bg-slate-900'>
        <h2 className='text-3xl font-bold mb-6 text-white'>Edit Product</h2>
        <form onSubmit={handleSubmit}>
            {/**name */}
            <div className="mb-6">
                <label className='block font-semibold mb-2 text-white'>Product Name</label>
                <input type="text" name="name" value={productData.name} 
                       onChange={handleChange} className='w-full border border-gray-50 rounded-md p-2' required/>
            </div>
            ...
            <div className="mb-6">
                ...
                <textarea name="description" value={productData.description} onChange={handleChange}
                        className='w-full border border-gray-50 rounded-md p-2' rows={4} required/>
            </div>
            ...
            <div className="mb-6">
                ...
                <input type="number" name='price' value={productData.price} 
                        onChange={handleChange} className='w-full border border-gray-50 rounded-md p-2'/>
            </div>

            {/**count in stock */}
            <div className="mb-6">
                <label className='block font-semibold mb-2 text-white'>Count In Stock</label>
            ...
            {/**sku */}
            <div className="mb-6">
                <label className='block font-semibold mb-2 text-white'>SKU</label>
            ...
            {/**Sizes */}
            <div className="mb-6">
                <label className='block font-semibold mb-2 text-white'>Sizes (comma-separated)</label>
                <input type="text" name='sizes' value={productData.sizes.join(", ")} 
                        ...
                        className='w-full border border-gray-50 rounded-md p-2'/>
            </div>

            {/**color */}
            <div className="mb-6">
                <label className='block font-semibold mb-2 text-white'>Colors (comma-separated)</label>
