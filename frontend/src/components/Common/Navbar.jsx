  ...
  return (
    ...
    <nav className='mx-auto flex items-center justify-between py-4 px-6 bg-lime-50'>
        ...
        <div className="hidden md:flex space-x-6">
            <Link to="/collections/all?gender=Men" className='text-gray-800 hover:text-black text-sm font-medium uppercase'>
            Men
            </Link>

            <Link to="/collections/all?gender=Women" className='text-gray-800 hover:text-black text-sm font-medium uppercase'>
            Women
            </Link>

            <Link to="/collections/all?category=Top Wear" className='text-gray-800 hover:text-black text-sm font-medium uppercase'>
            Top Wear
            </Link>

            <Link to="/collections/all?category=Bottom Wear" className='text-gray-800 hover:text-black text-sm font-medium uppercase'>
            Bottom Wear
            </Link>
        </div>
